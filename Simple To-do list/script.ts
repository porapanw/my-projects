...
const incompletedTaskList = document.getElementById('incompleted-task') as HTMLUListElement;
const completedTaskList = document.getElementById('completed-task') as HTMLUListElement;
...
function addTask(): void{
  ...
  if (element) {
    const taskInput = element as HTMLInputElement;
    if (taskInput.value == '') {
